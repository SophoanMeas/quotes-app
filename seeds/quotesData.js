...
const quotesData = [
	...
	{
		description: 'I put my heart and my soul into my work, and have lost my mind in the process',
	...
	{
		description: 'Science is not only compatible with spirituality; it is a profound source of spirituality.',
		author: 'Carl Sagan',
		likes: 50,
		user_id: 4,
		category_id: 4
	...
	{
		description: 'Build your own dreams or someone else will hire you to build theirs.',
		author: 'Farrah Gray',
		likes: 50,
		user_id: 4,
		category_id: 1
	...
	{
		description: 'The way I see it, if you want the rainbow, you gotta put up with the rain.',
		author: 'Dolly Parton',
		likes: 50,
		user_id: 4,
		category_id: 3
	...
	{
		description: 'The more I want to get something done the less I call it work.',
		author: 'Richard Bach',
		likes: 50,
		user_id: 4,
		category_id: 1
	...
	{
		description: 'Life is a succession of lessons which must be lived to be understood.',
		author: 'Helen Keller',
		likes: 50,
		user_id: 4,
		category_id: 3
	...
	{
		description: 'Life is ten percent what happens to you and ninety percent how you respond to it.',
